    ...
    return (
        <div className='border-b border-neutral-900 pb-20 mt-20 max-md-500:pb-10'>
            ...
            <article className='contact-form-ctr flex justify-center items-center p-4 max-md-500:px-0'>
                ...
                >
                    <div className=''>
                        <p className='text-3xl font-bold inline border-b-4 border-pink-600 text-neutral-300'>
                            Contact
                        </p>
                        <p className='text-neutral-300 py-4'>
                            Submit the form below or shoot me an email -
                            <span className='ml-1 border-b-2 border-pink-600'>
                                <Link to={'mailto:m.krastanov@outlook.com'}>m.krastanov@outlook.com</Link>
                            </span>
                        </p>
                        <input
                        ...
                        ></textarea>
                        <button type='submit' className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-3 mt-8 mx-auto flex items-center rounded'>
                            Let's Collaborate
                        </button>
                    </div>
                </form>
